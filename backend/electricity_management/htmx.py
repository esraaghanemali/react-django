...
class HTMXElectricityListView(generic.ListView):
...
class HTMXElectricityCreateView(generic.CreateView):
    model = models.Electricity
    form_class = forms.ElectricityForm
...
class HTMXElectricityDeleteView(generic.DeleteView):
    model = models.Electricity
    success_url = reverse_lazy("electricity_management_Electricity_htmx_list")
